...
exports.getAIRecommendations = exports.generatePropertyDescription = exports.naturalLanguageSearch = void 0;
const openai_1 = __importDefault(require("openai"));
const Property_1 = __importDefault(require("../models/Property"));
const openai = new openai_1.default({
    apiKey: process.env.OPENAI_API_KEY,
});
const naturalLanguageSearch = async (searchRequest) => {
    try {
...
const generatePropertyDescription = async (request) => {
    try {
...
const getAIRecommendations = async (request) => {
    try {
